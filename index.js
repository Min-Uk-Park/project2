...
rekognition.detectLabels(params, function(err, data) {
    if (err) {
        ...
        loadImage('project_sample4.jpg').then((image) => {
            ...
            // Draw circles and rectangles around objects in the foreground
            labels.forEach((label) => {
                ...
                label.Instances.forEach((instance) => {
                    if (instance.BoundingBox && instance.BoundingBox.Left) {
                        ...
                        // Draw the circle
                        context.beginPath();
                        context.arc(centerX, centerY, Math.max(width, height) / 2, 0, 2 * Math.PI);
                        context.lineWidth = 5;
                        ...
                        context.fillText(name, x, y - 5); // Adjust the text position to be above the shapes
                    }
                });
            });
